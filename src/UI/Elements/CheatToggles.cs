...
public struct CheatToggles
{
    ...
    // Exploits
    public static bool instantGameEnd;
    public static bool fourPlayersOnly;
    public static bool fullLobbies;
    public static int currentLobbyFilterSize = 0;
    public static string playerSearchFilter = "";
    public static float spamCallMeetingDelay = 0.25f;
